...
const About: React.FC = () => {
  ...
  <p className="text-gray-400 sm:text-base text-sm flex items-center justify-start py-4 ml-9">Shane Barakat</p>
  <p className="text-gray-400 sm:text-base text-sm flex items-center py-4 justify-end mr-9">Last Update - February 2025</p>
</div>
    </div>
  );
};
