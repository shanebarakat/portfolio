  ...
  return (
    <div className="bg-black text-white min-h-screen w-screen flex justify-center items-center px-6">
      ...
      <div className="w-full max-w-3xl">
        ...
        {/* Content */}
        <div className="p-4">
          <h1 className="text-5xl font-bold mb-3 text-center">PillThought</h1>
          <h2 className="text-center">Founding Engineer/COO</h2>
          <h2 className="mb-4 text-gray-500 text-center">Sept 2023 - Present</h2>
          ...
          <div className="text-left">
            ...
            <h2 className="text-3xl font-bold mb-4">Campus Pharmasave Mobile App</h2>
            <video
              src={PharmasaveVideo}
              className="rounded-lg cursor-pointer w-full h-auto mb-6"
              autoPlay
            ...
            <h2 className="text-3xl font-bold mb-4">Partners & Achievements</h2>
            <img
              src={achievements}
              alt="Achievements"
              className="rounded-lg cursor-pointer w-full h-auto mb-6"
